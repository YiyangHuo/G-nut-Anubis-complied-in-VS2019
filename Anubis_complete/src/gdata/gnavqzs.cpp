...
// ----------
/*
int t_gnavqzs::operator<(const t_gnavqzs& data) const
{       
...
// ----------
/*
int t_gnavqzs_struct::operator==(const t_gnavqzs& data) const
{       
  int _dtot = int( tot.diff( data.tot ) );
...
// return URA
// ----------
/* int t_gnavqzs::ura( double acc ) const */
/* { */
/*   gtrace("t_gnavgps::ura"); */
/*   unsigned int i; */
