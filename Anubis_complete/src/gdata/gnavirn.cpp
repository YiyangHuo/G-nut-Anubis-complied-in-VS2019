...
// ----------
/*
int t_gnavirn::operator<(const t_gnavirn& data) const
{       
...
// ----------
/*
int t_gnavirn_struct::operator==(const t_gnavirn& data) const
{       
  int _dtot = int( tot.diff( data.tot ) );
...
// return URA
// ----------
/* int t_gnavirn::ura( double acc ) const */
/* { */
/*   gtrace("t_gnavirn::ura"); */
/*   unsigned int i; */
